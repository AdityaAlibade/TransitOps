...
export const Expenses: React.FC = () => {
  ...
  const columns = [
    { header: 'Expense ID', accessor: 'expenseId' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 bg-white border border-slate-100 rounded-2xl shadow-sm">
        ...
        />
        <FilterPlaceholder 
          options={['All Statuses', 'Pending Approval', 'Approved', 'Rejected', 'Paid']}
          selected={filterVal}
      ...
      {/* Log Expense Modal Placeholder */}
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title="Log Operating Cost">
        <div className="space-y-4">
          <p className="text-sm text-slate-500">
            Log financial categories, item prices, corresponding vehicle registry, and upload transaction bill files.
          </p>
